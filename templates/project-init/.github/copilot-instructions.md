...
**No `.build/` directory:** This project has not been initialized. Read `[META_PROMPTS_PATH]/BOOTSTRAP.md` and follow the initialization sequence. Do not write application code until the sequence is complete and the human has approved the Phase 1 specification.
...
Meta-prompts location: `[META_PROMPTS_PATH]/`
